...
public class DropDownListWay2Automation {
	...
	public static void main(String[] args) {
		...
		List<WebElement> languageList = select.getOptions(); //Get's all the languages and puts in the list.
		...
		for(int i = 0; i < languageList.size(); i++) {
			...
			System.out.print("Wiki is available in " + languageList.size() +  " languages: " + lang + ", ");
		}
